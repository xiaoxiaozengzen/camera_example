...
void ShowHelpAndExit(const char *szBadOption = NULL)
{
    ...
    oss << "Options:" << std::endl
        ...
        << "-decsurf n    Allocate n number of decode surfaces at the time of initialization" << std::endl
        << "-extCudaStrm   Create the cuda stream in the App instead of the base class" <<std::endl
        ;
    oss << std::endl;
    if (bThrowError)
    {
...
int main(int argc, char **argv) 
{
    ...
    try
    {
        ...
        std::cout << "Using GPU " << iGpu << ", All GPUs: " << nGpu << std::endl;
